...
class UNetConfig:
    ...
    def __init__(self,
        ...
        self.images_dir = './dataset/rayence/processed/valid/CXR'
        self.masks_dir = './dataset/rayence/processed/valid/Mask'
        self.checkpoints_dir = './dataset/rayence/checkpoints'
